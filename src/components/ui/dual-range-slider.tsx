...
// Borrowed from https://shadcnui-expansions.typeart.cc/docs/dual-range-slider
...
>(({ className, label, labelPosition = 'top', ...props }, ref) => {
  ...
  return (
    <SliderPrimitive.Root
      ref={ref}
      className={cn('relative flex w-[95%] touch-none select-none items-center', className)}
      {...props}
    >
